...
export const Analyzer: React.FC = () => {
    ...
    return (
        <div className="w-full h-full">
            <div className="flex flex-wrap font-medium text-center text-gray-500 border-b border-gray-200 ml-3 dark:border-gray-700 dark:text-gray-400">
                <div
                    className={classnames("", {
                        "inline-block p-4 text-blue-600 bg-gray-50 rounded-t-lg active dark:bg-gray-800 dark:text-blue-500":
