...
proto.pb.unit.worker.Worker.toObject = function(includeInstance, msg) {
  var f, obj = {
    worrkerId: jspb.Message.getFieldWithDefault(msg, 1, ""),
...
/**
 * optional string worrker_id = 1;
 * @return {string}
 */
proto.pb.unit.worker.Worker.prototype.getWorrkerId = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};


/** @param {string} value */
proto.pb.unit.worker.Worker.prototype.setWorrkerId = function(value) {
